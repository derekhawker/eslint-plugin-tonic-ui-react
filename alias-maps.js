...
const spacingProps = new Set(["p", "padding", "paddingX", "px", "paddingY", "py", "paddingBlockEnd", "paddingBlockStart", "paddingBottom", "pb", "paddingInlineEnd", "paddingInlineStart", "paddingLeft", "pl", "paddingRight", "pr", "paddingTop", "pt", "margin", "m", "marginX", "mx", "marginY", "my", "marginBlockEnd", "marginBlockStart", "marginBottom", "mb", "marginInlineEnd", "marginInlineStart", "marginLeft", "ml", "marginRight", "mr", "marginTop", "mt", "gap", "colGap", "rowGap"]);
...
const colorProps = new Set(["color", "borderColor", "borderLeftColor", "borderTopColor", "borderRightColor", "borderBottomColor", "fill", "stroke", "background", "backgroundColor"]);
